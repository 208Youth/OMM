...
function CertModal({ cert, info, isClose }) {
  ...
  async function getVP() {
    const res = await createVerifiablePresentationJwt(
      vpPayload,
    ...
    <div>
      ...
      {!requireSearch.includes(cert) && (
        <div className="flex-col mx-auto">
          ...
          {(cert === '소득') && <div className='flex justify-center'>
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-piggy-bank text-[#4654A3]" viewBox="0 0 16 16">
          ...
          {(cert === '건강검진서') && <div className='flex justify-center'>
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-piggy-bank text-[#4654A3]" viewBox="0 0 16 16">
  ...
  <path d="M9.979 5.356a.5.5 0 0 0-.968.04L7.92 10.49l-.94-3.135a.5.5 0 0 0-.926-.08L4.69 10H4.5a.5.5 0 0 0 0 1H5a.5.5 0 0 0 .447-.276l.936-1.873 1.138 3.793a.5.5 0 0 0 .968-.04L9.58 7.51l.94 3.135A.5.5 0 0 0 11 11h.5a.5.5 0 0 0 0-1h-.128L9.979 5.356Z"/>
          ...
          {(cert === '부동산') && <div className='flex justify-center'>
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-piggy-bank text-[#4654A3]" viewBox="0 0 16 16">
