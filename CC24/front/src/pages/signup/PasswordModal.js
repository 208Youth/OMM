  ...
  return (
    <div className="flex-col mx-auto ">
      ...
      <form className='flex flex-col justify-center'>
        <input onKeyPress={handleKeyPress} type="password" value={pw} onChange={onChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-30 mx-auto my-2 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="••••••"/>
