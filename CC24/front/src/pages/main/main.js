  ...
  return (
    <div className="flex px-10">
      ...
      <div>
        ...
        {certList.map((cert) => (
          <SwiperSlide>
            <p className="text-3xl text-left leading-relaxed flex">
            ...
            <button onClick={() => setResult()} type="button" className=" inline text-white bg-[#4654a3] hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mt-1 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">인증서 가져오기</button>
          </SwiperSlide>
        ))}
      </Swiper>
